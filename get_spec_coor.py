...
for i_name in ilist21:
	...
	stokes_file.write(str(chan)+' '+str(peak_i)+' '+str(noise_i)+' '+str(peak_q)+' '+str(noise_q)+' '
		+str(peak_u)+' '+str(noise_u)+' '+str(peak_v)+' '+str(noise_v)+'\n')
...
plt.scatter(img1_peak[0],img1_peak[1],marker='o',facecolors='none',s=135,edgecolor='y')
...
plt.scatter(img2_peak[0],img2_peak[1],marker='o',facecolors='none',s=135,edgecolor='y')
...
plt.scatter(img3_peak[0],img3_peak[1],marker='o',facecolors='none',s=135,edgecolor='y')
...
axstokesQU.errorbar(lambda2,Q/I,yerr=Q_err/I,fmt='.',label="Stokes Q/Stokes I",c='tab:orange')
axstokesQU.errorbar(lambda2,U/I,yerr=U_err/I,fmt='.',label="Stokes U/Stokes I",c='tab:green')
